...
public class LetterboxSystem : MonoBehaviour
{    
    ...
    private void AddLetterBoxingCamera()
    {
        ...
        letterboxCamera.backgroundColor = matteColor;
        ...
        letterboxCamera.name = "LetterBox";        
    }
    ...
    private void PerformSizing()
    {
        ...
        if (referenceMode == LetterboxSystem.ReferenceMode.OrginalResolution)
