...
[CustomEditor(typeof(LetterboxSystem))]
public class LetterboxEditor : Editor
{
    ...
    override public void OnInspectorGUI()
    {
        ...
        LetterboxSystem.ReferenceMode currentReferenceMode = (LetterboxSystem.ReferenceMode)referenceModeProp.enumValueIndex;

        if (currentReferenceMode == LetterboxSystem.ReferenceMode.DesignedAspectRatio)
        {
